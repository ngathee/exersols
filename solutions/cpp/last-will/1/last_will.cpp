...
namespace estate_executor {
    ...
    int assemble_code() {
        int total_blue, total_red; 
        
        total_red = zhang::red::code_fragment() +  khan::red::code_fragment() + garcia::red::code_fragment();
        total_blue = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
